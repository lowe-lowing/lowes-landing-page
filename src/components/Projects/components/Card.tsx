...
import { Project, ProjectType } from "../ProjectData";
...
export const Card: React.FC<CardProps> = ({ project }) => {
  return (
    <div className="bg-card flex flex-col items-center p-5 gap-3 rounded-lg hover:scale-[1.02] transition-all h-min">
      ...
      <div className="text-xs text-primary">{project.description}</div>
