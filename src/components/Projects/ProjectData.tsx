...
export const projects: Project[] = [
  {
    ...
    icons: [
      <IconRenderer key={1} src="Typescript" alt="Typescript" title="Typescript" height={20} />,
      <IconRenderer key={2} src="Nextjs" alt="Nextjs" title="Nextjs" height={20} />,
      <IconRenderer key={3} src="Tailwindcss" alt="Tailwindcss" title="Tailwindcss" height={20} />,
      <IconRenderer key={4} src="Prisma" alt="Prisma" title="Prisma" height={20} />,
      <IconRenderer key={5} src="Trpc" alt="Trpc" title="Trpc" height={20} />,
    ],
  },
  {
    type: LinkType.Link,
    ...
    icons: [
      ...
      <IconRenderer key={3} src="Tailwindcss" alt="Tailwindcss" title="Tailwindcss" height={20} />,
      <IconRenderer key={4} src="Prisma" alt="Prisma" title="Prisma" height={20} />,
      <IconRenderer key={5} src="Redis" alt="Redis" title="Redis" height={20} />,
    ],
  },
  {
    type: LinkType.Link,
    ...
    icons: [
      <IconRenderer key={1} src="Typescript" alt="Typescript" title="Typescript" height={20} />,
      <IconRenderer key={2} src="Nextjs" alt="Nextjs" title="Nextjs" height={20} />,
      <IconRenderer key={3} src="Mysql" alt="Mysql" title="Mysql" height={20} />,
      <IconRenderer key={4} src="Tailwindcss" alt="Tailwindcss" title="Tailwindcss" height={20} />,
    ],
  },
  {
    type: LinkType.Buttons,
    ...
    icons: [
      <IconRenderer key={1} src="Typescript" alt="Typescript" title="Typescript" height={20} />,
      <IconRenderer key={2} src="React" alt="React" title="React" height={20} />,
      <IconRenderer key={3} src="Expo" alt="Expo" title="Expo" height={20} />,
      <IconRenderer key={4} src="Firebase" alt="Firebase" title="Firebase" height={20} />,
      <IconRenderer key={5} src="Nodejs" alt="Nodejs" title="Nodejs" height={20} />,
    ],
    gotoButtons: [
      // <IconRenderer
      //   key={1}
      //   src="AppStore"
      //   alt="A title="AppStore"ppStore"
      //   height={30}
      //   onClick={() => OpenInNewTab("https://apple.co/3Qk1KBx")}
      // />,
      // <IconRenderer key={1}
      //   src="GooglePlay"
      //   alt="G title="GooglePlay"ooglePlay"
      //   height={30}
  ...
  },
  {
    ...
    icons: [
      <IconRenderer key={1} src="Typescript" alt="React" title="Typescript" height={20} />,
      <IconRenderer key={2} src="React" alt="React" title="React" height={20} />,
      <IconRenderer key={3} src="Expo" alt="Expo" title="Expo" height={20} />,
      <IconRenderer key={4} src="Firebase" alt="Firebase" title="Firebase" height={20} />,
      <IconRenderer key={5} src="Nodejs" alt="Nodejs" title="Nodejs" height={20} />,
  ...
  },
  {
    ...
    icons: [
      <IconRenderer key={1} src="Nextjs" alt="Nextjs" title="Nextjs" height={20} />,
      <IconRenderer key={2} src="Sanity" alt="Sanity" title="Sanity" height={20} />,
      <IconRenderer key={3} src="Stripe" alt="Stripe" title="Stripe" height={20} />,
    ],
  },
  {
    type: LinkType.Link,
    ...
    icons: [
      <IconRenderer key={1} src="Php" alt="Php" title="Php" height={20} />,
      <IconRenderer key={2} src="Javascript" alt="Javascript" title="Javascript" height={20} />,
      <IconRenderer key={3} src="Mysql" alt="Mysql" title="Mysql" height={20} />,
    ],
  },
  {
    ...
    icons: [
      <IconRenderer key={1} src="React" alt="Javascript" title="React" height={20} />,
      <IconRenderer key={2} src="Tailwindcss" alt="Php" title="Tailwindcss" height={20} />,
      <IconRenderer key={3} src="Redux" alt="Mysql" title="Redux" height={20} />,
    ],
  },
  {
    type: LinkType.Link,
    ...
    icons: [
      <IconRenderer key={1} src="React" alt="Javascript" title="React" height={20} />,
      <IconRenderer key={2} src="Redux" alt="Mysql" title="Redux" height={20} />,
    ],
  },
];
