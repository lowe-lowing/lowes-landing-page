...
import { CVTitle, Education, Employment } from "./components";

export const Carreer = () => {
  return (
    <section className="flex flex-col items-center pt-10" id="Carreer">
      <Title>Carreer</Title>
      <div className="grid grid-cols-right-auto gap-10 text-primary w-[50%] bg-secondary p-5 rounded-xl">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Employment
                ...
                position={"Musiker"}
                dateDisplay={"Juni 2020 - Juni 2020"}
                description={
